...
现在如果你在选择卖塔之前选择了全技能，全技能的分数将不计入总分。

- 立即金币

对于游戏进程比较短的关卡，如 DQ9, DQ10, DQ11 等，立即金币的分数将等价于 +3% 的伤害，而非微小提升。此外，这个提升将和你选择的层数有关。

- DQ10 关卡内的易伤和全技能

易伤在 DQ10 内的得分将大幅调整，初始等价的伤害为 +8%，在你选择了伤害，攻速，暴击，全技能的奖励情况下，易伤的分数会显著提高，最高的分数可以等价于 +23% 的伤害。

全技能在 DQ10 内的得分将略微提高，且受到层数的影响。
...
当前仓库的数据使用 SeqUniverse-dqseq-20260127 进行生成。
